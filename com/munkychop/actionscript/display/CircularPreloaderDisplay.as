package com.munkychop.actionscript.display
{
	...
	public class CircularPreloaderDisplay extends Sprite
	{
		private var timer:Timer;
		private var slices:int;
		private var radius:int;

		public function CircularPreloaderDisplay (slices:int = 12, radius:int = 8)
		{
			super ();
			this.slices = slices;
			this.radius = radius;
		...
		private function getSlice ():Shape
		{
			...
			slice.graphics.beginFill (0xCCCCCC);
